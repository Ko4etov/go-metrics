...
const file_internal_proto_metrics_proto_rawDesc = "" +
	"\n" +
	"\x1cinternal/proto/metrics.proto\x12\ametrics\"\xa4\x01\n" +
	"\x06Metric\x12\x0e\n" +
	...
	"\x04hash\x18\x05 \x01(\tR\x04hash\"\x1f\n" +
	"\x05MType\x12\t\n" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB.Z,github.com/Ko4etov/go-metrics/internal/protob\x06proto3"
